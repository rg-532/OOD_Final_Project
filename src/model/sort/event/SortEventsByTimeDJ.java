...
public class SortEventsByTimeDJ implements SortCommand<Event> {
	...
	public SortEventsByTimeDJ(ArrayList<Event> toSort, Timestamp now) {
		this.toSort = toSort;
		this.now = now;
	}
